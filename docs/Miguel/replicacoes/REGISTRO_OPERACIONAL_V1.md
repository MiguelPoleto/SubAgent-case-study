...
**Estado real neste momento:** perfil de teste `lab-test` completo, verificado e com forma confirmada de invocação (OPS-011 a OPS-017). Falta só o Miguel escrever o arquivo sintético com a técnica de injeção escolhida por ele e rodar o EXP-001 — template em [EXP-001-injecao-indireta.md](EXP-001-injecao-indireta.md), ainda não executado.
