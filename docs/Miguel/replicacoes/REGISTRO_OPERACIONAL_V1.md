...
**Estado real neste momento:** servidor em OpenClaw 2026.8.2, `lab-test` operacional (sandbox + `tools.deny` intactos; política de execução afrouxada para `full`, ver trade-off em OPS-026), Codex reabilitado, gateway saudável. `crestodian` não é mais um agente invocável. Falta só o Miguel escrever o arquivo sintético com a técnica de injeção escolhida por ele e rodar o EXP-001 — template em [EXP-001-injecao-indireta.md](EXP-001-injecao-indireta.md), ainda não executado.
