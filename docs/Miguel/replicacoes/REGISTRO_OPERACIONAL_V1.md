...
**Estado real neste momento:** servidor em OpenClaw 2026.8.2, `lab-test` e `crestodian` verificados intactos após a migração de schema e de aprovações, plugin Codex desabilitado e gateway saudável. Falta só o Miguel escrever o arquivo sintético com a técnica de injeção escolhida por ele e rodar o EXP-001 — template em [EXP-001-injecao-indireta.md](EXP-001-injecao-indireta.md), ainda não executado.
